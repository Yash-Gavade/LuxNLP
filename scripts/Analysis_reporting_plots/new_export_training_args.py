...
# safe getter (returns "N/A" if missing)
...
def main():
    ...
    # PyTorch 2.6 fix: allow loading pickled TrainingArguments
    ...
    # Build rows from fields that actually exist
    rows = [
    ...
    # Add trainer_state extras if present
    ...
    if "log_history" in trainer_state and trainer_state["log_history"]:
        # last logged train loss (if exists)
