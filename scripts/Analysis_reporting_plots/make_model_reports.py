...
def main():
    ...
    # -----------------------------
    # EDIT THIS: your 3 models + their test files
    # -----------------------------
    MODELS = [
        {
            "name": "model_1_baseline_oldsplit",
            "model_dir": project_root / "models" / "xlmr_balanced_4k6k_focus_v1",
            "eval_conll": project_root / "data" / "processed" / "new_pipeline_v2" / "BALANCED_4K6K_FOCUS" / "test.conll",
        },
        {
            "name": "model_2_mixed_full",
            "model_dir": project_root / "models" / "xlmr_ner_mixed_lowcap",
            "eval_conll": project_root / "data" / "processed" / "mixed_splits" / "test_mixed.conll",
        },
        {
