...
# Only keep these parts of speech as "entity-like" (nouns)
ALLOWED_POS = {"SUBST"}  # adjust later if you want more, e.g. {"SUBST", "NB"}

# High-level NER groups based on LOD category codes
CATEGORY_GROUPS = {
    # --- MEDICINE-like things ---
...
def main():
    ...
    with lod_path.open("r", encoding="utf-8") as f_in:
        for line in f_in:
            ...
            # POS filter: only keep nouns (SUBST)
