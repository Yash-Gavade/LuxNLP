...
def compute_metrics(p, id2label):
    ...
    acc_non_o = correct_non_o / total_non_o if total_non_o else 0.0
    return {"token_acc": acc, "token_acc_non_o": acc_non_o}
...
def main():
    ...
    training_args = TrainingArguments(
        ...
        metric_for_best_model="token_acc_non_o",
        report_to="none",
        seed=args.seed,
    )
    ...
    print("\nTest set evaluation:")
    print(trainer.evaluate(dsd["test"]))
